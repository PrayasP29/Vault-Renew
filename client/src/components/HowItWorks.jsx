export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="text-white border-y border-white/5 bg-white/[0.02]">
      <div className="mx-auto max-w-[1160px] px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
          {steps.map((s) => (
            <div key={s.n} className="rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur p-6">
